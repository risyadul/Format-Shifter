...
/**
 * WASM/JS implementation of FileDownloaderProvider (placeholder)
 */
actual object FileDownloaderProvider {
    actual fun provide(): FileDownloader = WasmFileDownloader()
}

private class WasmFileDownloader : FileDownloader {
    override suspend fun downloadFile(task: ConversionTask): Boolean {
        throw FileDownloadException("WASM file download not implemented yet")
    }
